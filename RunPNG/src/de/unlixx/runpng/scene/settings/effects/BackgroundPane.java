...
/**
 * Implementation of a background effect for the main image sequence.
 *
...
public class BackgroundPane extends AbstractEffectPane
{
	 ...
	 */
	public BackgroundPane(EventHandler<ActionEvent> handlerEffectAction)
	{
		...
		m_thumbnailPane = new ThumbnailPane("background", this);
	...
	public Image applyEffect(int nFrame, Image image)
	{
		...
		return ImageUtil.imageApplyBackground(image, m_pickerPlain.getValue(), m_thumbnailPane.getScaledViewImage());
	}
